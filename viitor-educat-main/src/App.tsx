...
import { CyberLabPage } from "@/modules/cyberlab/pages/CyberLabPage";
import { CyberLabChallengesPage } from "@/modules/cyberlab/pages/CyberLabChallengesPage";
import { CyberLabLessonsPage } from "@/modules/cyberlab/pages/CyberLabLessonsPage";
import { CyberLayout } from "@/modules/cyberlab/components/CyberLayout";
import { TeacherCyberLabPage } from "@/modules/cyberlab/pages/teacher/TeacherCyberLabPage";
...
const App = () => (
  <HelmetProvider>
    <QueryClientProvider client={queryClient}>
      <ThemeProvider attribute="class" defaultTheme="dark" enableSystem={false} themes={['light', 'dark', 'aurora-light', 'aurora-dark']}>
        <AuthProvider>
          <SettingsProvider>
            <DraftProvider>
              <ErrorBoundary>
                <TooltipProvider>
                  ...
                  <BrowserRouter>
                    ...
                    <Routes>
                      ...
                      <Route path="/instructors" element={<ErrorBoundary><TeacherDirectoryPage /></ErrorBoundary>} />
                      ...
                      <Route path="/cyberlab" element={
                        <ProtectedRoute allowedRoles={['STUDENT','TEACHER','ADMIN']}>
                          <CyberLayout>
                            <ErrorBoundary><CyberLabPage /></ErrorBoundary>
                          </CyberLayout>
                        </ProtectedRoute>
                      } />

                      {/* Student CyberLab - Challenges Only */}
                      <Route path="/student/cyberlab_challenges" element={
                        <ProtectedRoute allowedRoles={['STUDENT','TEACHER','ADMIN']}>
                          <CyberLayout>
                            <ErrorBoundary><CyberLabChallengesPage /></ErrorBoundary>
                          </CyberLayout>
                        </ProtectedRoute>
                      } />

                      {/* Student CyberLab - Lessons/Training */}
                      <Route path="/student/cyberlab_lessons" element={
                        <ProtectedRoute allowedRoles={['STUDENT','TEACHER','ADMIN']}>
                          <CyberLayout>
                            <ErrorBoundary><CyberLabLessonsPage /></ErrorBoundary>
                          </CyberLayout>
                        </ProtectedRoute>
                      } />

                      {/* Teacher CyberLab Management */}
                      <Route path="/teacher/cyberlab" element={
                        <ProtectedRoute allowedRoles={['TEACHER', 'ADMIN']}>
                          <ErrorBoundary><TeacherCyberLabPage /></ErrorBoundary>
                        </ProtectedRoute>
                      } />
