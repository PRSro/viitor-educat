...
const getCategoryIcon = (category: string): typeof Award => {
  ...
  if (lower.includes("ctf") || lower.includes("olimpiad") || lower.includes("concurs")) return Award;
  if (lower.includes("eveniment") || lower.includes("event")) return Calendar;
  if (lower.includes("angaj") || lower.includes("job")) return Users;
  return BookOpen;
};
      ...
      try {
        ...
        const items = Array.from(xml.querySelectorAll("item")).map((item) => {
          ...
          return {
            ...
            link,
            pubDate,
            categories: categories.filter((c) => c !== "Stiri" && c !== "News"),
          ...
          <div className="text-center py-20">
            <div className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-destructive/10 border border-destructive/20 text-destructive mb-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm opacity-80">Check your connection or try again</p>
              </div>
            </div>
            <br />
