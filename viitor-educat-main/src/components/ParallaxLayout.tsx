    ...
    <div className={cn('relative overflow-hidden', className)}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse at center, hsl(290 70% 60% / 0.3) 0%, transparent 70%)',
          }}
        />
        <div 
          className="absolute top-1/4 right-1/4 w-96 h-96 animate-parallax-medium opacity-20"
          style={{
            background: 'radial-gradient(circle, hsl(305 70% 55% / 0.4) 0%, transparent 70%)',
          }}
        />
        <div 
          className="absolute bottom-0 left-1/3 w-[800px] h-[400px] animate-parallax-slow opacity-25"
          style={{
            background: 'radial-gradient(ellipse at center, hsl(285 60% 45% / 0.3) 0%, transparent 60%)',
          }}
        />
      </div>
      ...
      {particles.map((particle) => (
        <div
          ...
          style={{
            ...
            background: 'hsl(290 60% 60% / 0.6)',
            animationDelay: `${particle.delay}s`,
            animationDuration: `${particle.duration}s`,
            boxShadow: '0 0 10px hsl(290 70% 60% / 0.4)',
          }}
        />
      ))}
