...
export const forumController = {
    ...
    async getThread(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
        const user = getUser(request);
    ...
    async createThread(request: FastifyRequest, reply: FastifyReply) {
        const user = getUser(request);
    ...
    async createPost(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
        const user = getUser(request);
        const { id } = request.params;
